...
app.controller('listController',['$scope','$http','$rootScope',function($scope , $http , $rootScope){
    ...
    var list = sessionStorage.getItem('defaultList');
...
//                                console.log(response[i]);
                ...
                $scope.data = response;
                sessionStorage.setItem('defaultList' , JSON.stringify(response));
            }
        );
    };
...
//        $("html,body").animate({scrollTop: 0}, 200);
        $scope.data = JSON.parse(sessionStorage.defaultList);
    ...
    $scope.sort = function(){
        ...
        //$('.list').empty();
        var defaultList = JSON.parse(sessionStorage.getItem('defaultList'));
        var sortList = sessionStorage.getItem('sortList');
        if(null == sortList || JSON.parse(sortList).length == 0){
            sessionStorage.sortList = JSON.stringify(defaultList.sort(
                function(a,b){
        ...
        //$("html,body").animate({scrollTop: 0}, 200);
        $scope.data = JSON.parse(sessionStorage.getItem('sortList'));
    }
    ...
    if(null != sessionStorage.getItem('new') && JSON.parse(sessionStorage.getItem('new')).length != 0){
        $scope.new = JSON.parse(sessionStorage.getItem('new'));
    }
    if(null != sessionStorage.getItem('hot') && JSON.parse(sessionStorage.getItem('hot')).length != 0){
        $scope.hot = JSON.parse(sessionStorage.getItem('hot'));
    }
    if(null != sessionStorage.getItem('types') && JSON.parse(sessionStorage.getItem('types')).length != 0){
        $scope.types = JSON.parse(sessionStorage.getItem('types'));
    }
    ...
    $http
        ...
        .success(function(response){
            ...
            sessionStorage.setItem('new' , JSON.stringify(response.newCups));
            sessionStorage.setItem('hot' , JSON.stringify(response.hotCups));
            sessionStorage.setItem('types' , JSON.stringify(response.typeCups));
        });
